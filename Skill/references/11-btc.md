...
## Facts
- **Band**: 2.402–2.480 GHz — 79 RF channels × 1 MHz, **adaptive frequency hopping ~1600 hops/s**. That fast hopping is what makes it hard to follow with a static SDR.
- **Modulation/rate**: Basic Rate (BR) GFSK 1 Mbps; EDR π/4-DQPSK 2 Mbps and 8DPSK 3 Mbps.
...
- **Kit**: BrakTooth PoC (ESP32, LMP/baseband fuzzing), `esp32-bluejammer` (broadband 2.4 GHz jamming with 2× nRF24L01+PA+LNA — **illegal over the air**).
- **Deference**: BSAM. `deferred: true`.
