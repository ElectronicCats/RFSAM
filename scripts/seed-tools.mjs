...
const tools = [
  ...
  },
  {
    ...
    note: 'The CatSniffer host toolset (CatSniffer-Tools). Its pycatsniffer drives a CatSniffer to sniff IEEE 802.15.4 / Zigbee and BLE with native Wireshark extcap integration; it also presents the CatSniffer as a virtual HCI (vHCI) Bluetooth adapter on Linux so host BLE tools like Bleak and bettercap can drive it. On the sub-1 GHz side it captures LoRa and Meshtastic through the CatSniffer\'s Semtech SX1262, and the CC1352P sniffer firmware adds IEEE 802.15.4g — all into Wireshark.',
  },
  {
