    ...
    layers: {
      ...
      SP: {
        ...
        tools: [
          ...
          { tool: 'catnip', role: 'Find My / AirTag survey', why: 'The CatSniffer AirTag-scanner firmware, run from catnip, is a standalone detector for Apple Find My / AirTag advertisements - a CatSniffer-native tracker sweep from the board, printed to the serial console.', caveat: 'Detection survey only (passive); the separate airtag_spoofer firmware transmits and is out of scope for a survey.', deps: ['catsniffer'] },
        ],
      },
      PHY: {
