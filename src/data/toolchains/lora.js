  ...
  "layers": {
    ...
    "SP": {
      ...
      "tools": [
        ...
        { "tool": "chirpcat", "role": "Gateway-fed discovery & classification", "why": "Electronic Cats’ LoRa/LoRaWAN platform: ingests traffic via a gateway backend (Semtech UDP packet forwarder), clusters packets by RF characteristics, scores/classifies targets and dispatches follow/capture tasks to CatSniffer workers — a survey-and-orchestration layer when you have gateway access.", "caveat": "Needs a gateway feed (designed for the RAK WisGate / SX130x); new project — verify maturity before relying on it.", "deps": ["catsniffer"] }
      ]
    },
    "PHY": {
