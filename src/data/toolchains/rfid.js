  ...
  "layers": {
    ...
    "SP": {
      ...
      "tools": [
        ...
        { "tool": "pm3-client", "role": "Passive sniffer", "why": "When a real reader and card are already interacting, `hf 14a sniff` / `hf 15 sniff` / `lf sniff` eavesdrop the exchange through the Proxmark without transmitting — the reader supplies the field and the Proxmark only records both sides — so you see the standard, the UID and the actual command/APDU traffic from a genuine transaction. The reader↔card authentication it captures is also what mfkey32/mfkey64 need at the Break-crypto step.", "deps": ["proxmark3"] },
