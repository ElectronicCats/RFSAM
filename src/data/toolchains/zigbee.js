  ...
  "layers": {
    ...
    "SP": {
      ...
      "tools": [
        ...
        { "tool": "catnip", "role": "Channel activity & topology (cativity)", "why": "catnip's cativity mode channel-hops 802.15.4 (11–26) and draws a live per-channel activity table — so you spot the busy Zigbee channel at a glance — with a fixed-channel mode for detail and a network-topology discovery that maps the coordinator / router / end-device relationships. Runs on the CatSniffer, native to the EC kit.", "deps": ["catsniffer"] }
      ]
    },
    "PHY": {
